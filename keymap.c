...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        LT(HYPR,KC_ESC),   HOME_A,HOME_S,HOME_D,HOME_F,KC_G,              KC_H,  HOME_J,  HOME_K,   HOME_L,    LT(SYMBOLS,KC_SCLN),KC_QUOT,  KC_ENT, MO(FN2),
    ...
    [MOUSE] = LAYOUT_69_ansi(
        ...
        _______,           _______,  _______, _______, _______, _______,  _______, _______, _______, _______,  _______,  _______,  _______,  _______,
        _______, _______,  _______,           _______,          _______,  KC_BTN2,          KC_BTN1,           _______,            _______, _______, _______),
