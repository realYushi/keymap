...
enum TD_keycodes { TD_CBR, TD_ABR, TD_PRN, TD_SBR, TD_HYPR };
tap_dance_action_t tap_dance_actions[] = {[TD_CBR] = ACTION_TAP_DANCE_DOUBLE(KC_LCBR, KC_RCBR), [TD_ABR] = ACTION_TAP_DANCE_DOUBLE(KC_LABK, KC_RABK), [TD_PRN] = ACTION_TAP_DANCE_DOUBLE(KC_LPRN, KC_RPRN), [TD_SBR] = ACTION_TAP_DANCE_DOUBLE(KC_LBRC, KC_RBRC), [TD_HYPR] = ACTION_TAP_DANCE_DOUBLE(LALT(KC_BSPC), KC_F19)};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        KC_LCTL, KC_LOPTN, KC_LCMMD,          LT(SYMBOLS,KC_SPC),LT(NUMBERS,KC_ENT) , HYPR_T(TD_HYPR),LT(SYMBOLS,KC_BSPC),KC_RCMMD,   KC_LEFT, KC_DOWN, KC_RGHT),
